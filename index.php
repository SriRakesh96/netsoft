            ...
            <div class="col-xl-8 col-lg-7">
                <div class="cta-content md-text-center">
                    <h3 class="heading text-white">
                        Looking for Certified <span class="text-color-secondary">SAP Talent</span> 
                        to Drive Your Next Project?
                    </h3>
                    <p class="text-white mt-3">
                        Netsoft delivers experienced SAP consultants and workforce solutions 
                        tailored to your enterprise goals, timelines, and budget.
                    </p>
                </div>
            </div>
